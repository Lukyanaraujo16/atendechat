    ...
    translations: {
      ...
      technicalConsole: {
        accessDenied: {
          ...
          description:
            "Esta área está disponible solo para usuarios internos autorizados.",
        },
        landing: {
          title: "Consola Técnica",
          subtitle:
            "Entorno interno de operación y observabilidad del AgentOS.",
          authorized: "Acceso interno autorizado.",
          internalNotice:
            "Área restringida a operadores internos. No sustituye el producto comercial.",
          nextSteps:
            "Use la navegación interna para abrir los módulos técnicos.",
        },
        shell: {
          title: "Consola Técnica",
          home: "Inicio",
          internalBadge: "Entorno interno",
          activeCompany: "Empresa activa: {{name}}",
          supportContext: "Contexto de soporte",
          backToProduct: "Volver al producto",
          openModules: "Abrir módulos",
          navAria: "Navegación de la Consola Técnica",
        },
        groups: {
          operation: "Operación",
          quality: "Calidad y análisis",
          intelligence: "Inteligencia",
          tools: "Herramientas e integraciones internas",
          delivery: "Entrega y producción",
        },
        nav: {
          monitor: "Monitor",
          observability: "Observabilidad",
          executionSessions: "Sesiones de ejecución",
          runtime: "Runtime",
          actions: "Acciones",
          analytics: "Analytics",
        ...
        readOnly: {
          banner:
            "Acceso de solo lectura. Las acciones sensibles requieren un permiso adicional.",
        },
        actionDenied: {
          message: "No tiene autorización para ejecutar esta acción.",
        },
        empty: {
          executions: "No se encontraron ejecuciones para el contexto actual.",
          evidence: "No se registró evidencia para el contexto actual.",
          incidents: "No hay incidentes activos en el contexto actual.",
          actions: "No hay acciones técnicas disponibles en el contexto actual.",
          memory: "No hay memoria registrada para el contexto actual.",
        },
        confirm: {
          killTitle: "Activar kill switch",
          killBody:
            "Esto detiene Function Calling Live para la empresa activa ({{company}}). Confirme solo si es intencional.",
          killConfirm: "Activar kill switch",
          rollbackTitle: "Ejecutar rollback Live",
          rollbackBody:
            "Esto revierte la etapa Live de la empresa activa ({{company}}). El cambio es inmediato.",
          rollbackConfirm: "Ejecutar rollback",
          emergencyTitle: "Emergency stop",
          emergencyBody:
            "Parada de emergencia en la empresa activa ({{company}}). Úselo solo en incidentes críticos.",
          emergencyConfirm: "Confirmar emergency stop",
        },
        notFound: {
          title: "Página técnica no encontrada",
          description: "Esta ruta no existe en la Consola Técnica.",
        },
      },
      groups: {
        manager: {
        ...
        inbox: {
          chipGroup: "Grupo",
          chipNoConversation: "Sin conversación",
          chipStart: "Iniciar",
          noConversationYet: "Aún sin conversación",
          openingConversation: "Abriendo conversación del grupo…",
          emptyTitle: "No hay grupos disponibles",
          emptyDescription:
            "No hay conversaciones de grupo ni grupos autorizados para sus sectores.",
          emptyHint:
      ...
      inventorySales: {
        ...
        subtitle: "Gestione productos, categorías, inventario y configuración del módulo.",
        tabs: {
          summary: "Resumen",
          products: "Productos",
        ...
        products: {
          ...
          search: "Buscar nombre, SKU o código de barras",
          filterCategory: "Categoría",
          filterActive: "Estado",
          min: "mín.",
          noStockTracking: "Sin control",
          lowStockBadge: "Stock bajo",
          viewHistory: "Historial de stock",
          ...
          validation: {
            ...
            salePrice: "Precio de venta inválido.",
            initialQty: "Cantidad inicial inválida.",
          },
          toasts: {
        ...
        categories: {
          ...
          emptyDescription: "Organice sus productos en categorías.",
          deactivateTitle: "Desactivar categoría",
          deactivateMessage: "¿Desea desactivar «{{name}}»?",
          columns: {
            name: "Nombre",
        ...
        stock: {
          ...
          emptyDescription: "Registre entradas, salidas o ajustes de stock.",
          types: {
            in: "Entrada",
            out: "Salida",
            adjustment: "Ajuste",
          ...
          hints: {
            adjustment: "En el ajuste, indique el saldo final deseado.",
            notesRequired: "Obligatorio para salida y ajuste.",
          },
          validation: {
            product: "Seleccione un producto.",
            quantity: "Cantidad inválida.",
            quantityPositive: "La cantidad debe ser mayor que cero.",
            notes: "Ingrese la observación.",
          },
          columns: {
            date: "Fecha",
            product: "Producto",
        ...
        sales: {
          ...
          searchContact: "Buscar cliente…",
          cancelReasonLabel: "Motivo de cancelación",
          confirmCompleteTitle: "Concluir venta",
          confirmCompleteMessage:
            "La venta se finalizará y se descontará el stock. ¿Desea continuar?",
          confirmCancelTitle: "Cancelar venta",
          confirmCancelDraftMessage: "El borrador será cancelado.",
          confirmCancelCompletedMessage:
            "La venta concluida será cancelada y el stock será revertido.",
          confirmDeleteTitle: "Eliminar borrador",
          confirmDeleteMessage:
            "Esta acción elimina el borrador y todos los ítems. No se puede deshacer.",
          emptyTitle: "No se encontraron ventas",
          emptyDescription: "Cree una nueva venta para comenzar.",
          pagination: "Página {{page}} · {{count}} registro(s)",
          status: {
            draft: "Borrador",
            completed: "Concluida",
            cancelled: "Cancelada",
          ...
          items: {
            ...
            validation: {
              product: "Seleccione un producto.",
              quantity: "Cantidad inválida.",
              unitPrice: "Precio unitario inválido.",
            },
            toasts: {
              added: "Ítem agregado.",
            ...
            identifiers: {
              ...
              hint:
                "Ej.: número de serie, IMEI, MAC, chasis o código de fabricación.",
              unitLabel: "Unidad {{position}}",
              add: "Agregar identificación",
              remove: "Quitar identificación",
              duplicate:
                "Esta identificación ya fue usada en otra unidad de este ítem.",
              integerOnly:
                "La identificación por unidad está disponible solo para cantidades enteras.",
              fractionalNeedsClear:
                "Quite las identificaciones de las unidades antes de usar una cantidad fraccionaria.",
              removeAll: "Quitar todas las identificaciones",
              listTitle: "Identificaciones",
              reduceQuantity:
                "Quite la identificación de la unidad {{position}} antes de reducir la cantidad.",
            },
          },
          toasts: {
        ...
        ticket: {
          sectionTitle: "Ventas de este atendimiento",
          newSale: "Nueva venta",
          openSale: "Venta",
          noSales: "Ninguna venta vinculada a este atendimiento.",
          existingSalesTitle: "Ventas del atendimiento",
          existingSalesHint:
            "Este atendimiento ya tiene ventas. Abra una existente o cree una nueva.",
          createNewAnyway: "Crear nueva venta",
          ticketLabel: "Atendimiento",
          toasts: {
            created: "Venta vinculada al atendimiento.",
          },
        },
        reports: {
          ...
          emptyDescription:
            "No hay ventas concluidas o canceladas para los filtros seleccionados.",
          noRows: "Sin registros en este informe.",
          noSeller: "Sin vendedor",
          salesShort: "ventas",
          sellersTitle: "Ventas por vendedor",
          productsTitle: "Productos más vendidos",
          customersTitle: "Ventas por cliente",
          summary: {
            totalSold: "Total vendido",
            completedCount: "Ventas concluidas",
      ...
      plans: {
        ...
        features: {
          ...
          automation: {
            ...
            ai_tools: {
              label: "Herramientas IA (Tools)",
              description:
                "Capa de Tools del Automation Orchestrator para capacidades operativas gobernadas (fundación; sin ejecución productiva automática en esta fase).",
            },
            keywords: {
          ...
          settings: {
            ...
            instagram_integration: {
              label: "Instagram",
              description: "Permite conectar Instagram y atender Directs.",
            },
          },
        },
      },
      kanban: {
        ...
        collapsedDropHint: "Suelte aquí para mover",
        showingCount: "Mostrando {{visible}} de {{total}}",
        loadMore: "Cargar más tickets",
        filters: {
          user: "Usuario",
          queue: "Sector",
          connection: "Conexión",
        ...
        connectionFallback: "Conexión {{id}}",
        searchPlaceholder: "Buscar en el Kanban...",
        searchClear: "Limpiar búsqueda",
        filteringBy: "Filtrando por: {{term}}",
        countFiltered: "{{filtered}} de {{total}}",
        searchEmptyColumn: "Ningún ticket coincide con la búsqueda en esta columna.",
        ...
        drag: {
          blockedClosedToPending:
            "No se puede mover un ticket finalizado a En espera. Arrástrelo a En atención para reabrir.",
        },
        quickActions: {
      ...
      connections: {
        ...
        instagram: {
          guide: {
            ...
            intro:
              "Conecte su cuenta profesional de Instagram para recibir y responder Directs en AtendeChat.",
            step1: "Haga clic en \"Agregar cuenta Instagram\", ingrese el nombre y guarde.",
            step2: "Haga clic en \"Conectar con Instagram\" y autorice la app en Meta.",
            requirementsTitle: "Requisitos:",
            requirement1: "Cuenta Instagram profesional Business o Creator",
            requirement2: "Permisos aprobados en Meta",
            requirement3: "App autorizada en la pantalla de inicio de sesión",
          },
          statusLabel: {
            CONNECTED: "Conectado",
          ...
          toasts: {
            ...
            disconnected: "Cuenta de Instagram desconectada.",
          },
          confirmationModal: {
            deleteTitle: "Eliminar cuenta",
            deleteMessage: "¿Está seguro? Esta acción no puede ser revertida.",
            disconnectTitle: "Desconectar",
            disconnectMessage: "El token se eliminará de forma segura. ¿Desea continuar?",
          },
          buttons: {
            add: "Agregar cuenta Instagram",
            connectInstagram: "Conectar con Instagram",
            reconnectInstagram: "Reconectar Instagram",
            migrateToInstagram: "Migrar al login de Instagram",
            connectManually: "Conectar manualmente",
            connectToken: "Token manual (avanzado)",
            disconnect: "Desconectar",
          },
          advancedOptions: "Opciones avanzadas",
          advancedOptionsHint:
            "Use solo si recibió un token generado manualmente por Meta.",
          oauth: {
            success: "Instagram conectado con éxito.",
            expired: "Token expirado",
            expiresToday: "Expira hoy",
            expiresInDays: "Expira en {{days}} días",
            connectedViaOAuth: "Conectado vía Instagram",
            connectedViaOAuthTooltip:
              "Conexión realizada mediante el login oficial de Meta.",
            connectedViaManual: "Token manual",
            disconnected: "Desconectado",
            reconnect: "Reconectar",
            errorChip: "Error",
            attentionChip: "Atención",
            ...
            errors: {
              ...
              missing_code: "Meta no devolvió autorización. Intente de nuevo.",
              missing_scopes: "La cuenta no concedió todos los permisos necesarios.",
              not_business:
                "Esta cuenta de Instagram debe ser profesional Business o Creator.",
              user_denied: "Conexión cancelada en Instagram.",
              duplicate_account: "Esta cuenta de Instagram ya está conectada en esta empresa.",
              plan_not_available:
                "Su plan no incluye acceso a la integración con Instagram.",
              generic: "No se pudo conectar Instagram.",
            },
          },
          connectToken: {
            title: "Token manual (avanzado)",
            warning:
              "Use solo tokens generados en Meta for Developers. El token se almacenará de forma segura y no se mostrará de nuevo.",
            hint: "Pegue abajo el token de acceso de la cuenta Instagram Business. Use solo si recibió un token generado manualmente por Meta.",
            tokenLabel: "Token de acceso",
            submit: "Validar y conectar",
            cancel: "Cancelar",
            success: "¡Cuenta de Instagram conectada con éxito!",
            errors: {
              empty: "Ingrese el token de acceso.",
            },
          },
          table: {
            name: "Nombre",
            ...
            connection: "Conexión",
            tokenExpires: "Expira en",
            lastUpdate: "Última actualización",
            default: "Predeterminado",
            actions: "Acciones",
            emptyTitle: "Sin cuentas de Instagram",
            emptyHint: "Agregue una cuenta y conéctela con Instagram.",
          ...
          webhook: {
            ...
            accountWebhook: "Webhook de la cuenta",
            accountStatusUnknown: "No verificado",
            verify: "Verificar webhook",
            subscribe: "Suscribir webhook de la cuenta",
            subscribeSuccess: "Suscripción de webhook solicitada con éxito.",
            diagnosticsLoaded: "Diagnóstico de webhook actualizado.",
      ...
      whatsappModal: {
        ...
        form: {
          ...
          ticketVisibility: "Visibilidad de tickets de esta conexión",
          ticketVisibilityAll: "Todos los usuarios con acceso al inbox",
      ...
      contacts: {
        ...
        assignments: {
          ...
          requiresOne: "Seleccione al menos un responsable del contacto.",
        },
      },
      contactLabelsManage: {
      ...
      aiAgentProduct: {
        ...
        configurationErrors: {
          ambiguous:
            "Existen múltiples configuraciones de Agente de IA. Resuelva antes de continuar.",
          alreadyExists: "Ya existe un Agente de IA configurado.",
          updateNotAllowed:
            "Desactive el agente antes de cambiar esta configuración.",
          connectionAssigned:
            "Esta conexión ya está vinculada a otro agente.",
          connectionInvalid:
            "Conexión inválida o no pertenece a la empresa.",
          credentialInvalid:
            "Credencial inválida o no pertenece a la empresa.",
          providerInvalid: "Proveedor no soportado.",
        },
        confirm: {
          activate_shadow: {
        ...
        checks: {
          ...
          credential: "Credencial del proveedor",
          credentialIncompatible: "Credencial incompatible con el proveedor",
          credentialDisabled: "Credencial deshabilitada",
          model: "Modelo de IA",
          modelIncompatible: "Modelo incompatible con el proveedor",
        ...
        checkDescription: {
          ...
          provider: "Proveedor comercial soportado y configurado.",
          providerUnsupported: "El proveedor configurado no es soportado por el producto.",
          credential: "Credencial seleccionada, habilitada y compatible con el proveedor.",
          credentialIncompatible:
            "La credencial seleccionada no es compatible con el proveedor.",
          credentialDisabled: "La credencial seleccionada está deshabilitada.",
          model: "Modelo compatible con el proveedor configurado.",
          modelIncompatible:
            "El modelo seleccionado no pertenece al proveedor configurado.",
        ...
        secondary: {
          ...
          openCredentials: "Abrir credenciales",
          manageCredentials: "Gestionar credenciales",
        },
        credentials: {
          title: "Credenciales de IA",
          subtitle:
            "Agregue y gestione las claves utilizadas por el Agente de IA.",
          empty: "No hay credenciales registradas.",
          defaultBadge: "Predeterminada",
          fields: {
            name: "Nombre",
            provider: "Proveedor",
            apiKey: "Clave de API",
            isDefault: "Usar como credencial predeterminada",
            keepKey: "Déjelo en blanco para conservar la clave actual.",
          },
          actions: {
            add: "Agregar credencial",
            edit: "Editar",
            test: "Probar",
            testing: "Probando…",
            enable: "Habilitar",
          ...
          test: {
            ...
            failure: "No se pudo validar la credencial.",
          },
          confirmDisable: {
            message:
              "¿Deshabilitar la credencial “{{name}}”? Ya no estará disponible para el Agente de IA.",
            action: "Confirmar desactivación",
          },
          errors: {
        ...
        simulator: {
          reasons: {
            not_created:
              "Cree el Agente de IA antes de probar la conversación.",
            ambiguous:
              "Hay varias configuraciones de Agente de IA. Resuelva antes de simular.",
            credential_not_selected:
              "Seleccione una credencial de proveedor en el asistente para usar el simulador.",
            credential_disabled:
              "La credencial vinculada está deshabilitada. Actívela o elija otra.",
            provider_unsupported:
              "El proveedor configurado no es compatible con el simulador comercial.",
            model_incompatible:
              "El modelo configurado es incompatible con el proveedor seleccionado.",
            simulator_not_configured:
              "Complete la configuración del Agente de IA para usar el simulador.",
          },
          cta: {
            configure: "Configurar agente",
            hub: "Volver al Agente de IA",
          },
        },
        meta: {
          agent: "Agente: {{name}}",
      ...
      aiAgent: {
        ...
        wizard: {
          ...
          hints: {
            suggestedFaqsReview:
              "Revise y responda las preguntas sugeridas antes de finalizar.",
          },
          segment: {
            panelTitle: "Recomendaciones para {{segment}}",
            panelHint:
              "Sugerimos opciones seguras para este tipo de negocio. Nada se aplicará sin su confirmación.",
            applyButton: "Aplicar recomendaciones",
            applyConfirmTitle: "¿Aplicar recomendaciones del segmento?",
            applyConfirmMessage:
              "Se agregarán hasta {{departments}} departamento(s), {{actions}} acción(es) y {{handoffs}} regla(s) de transferencia. Los campos ya completados no se modificarán.",
            applySuccess: "Recomendaciones aplicadas",
            changedWarning:
              "El segmento fue cambiado. ¿Desea revisar las nuevas recomendaciones?",
            chipDepartments: "{{count}} departamentos",
            chipActions: "{{count}} acciones",
            chipHandoffs: "{{count}} transferencias",
            chipQuestions: "{{count}} preguntas",
            qualificationTitle: "Preguntas útiles de calificación",
            checklistTitle: "Para mejorar la atención, informe cuando sea posible:",
            checklistDone: "informado",
            checklistPending: "pendiente",
          },
        },
        segmentTemplates: {
          other: { title: "Otro segmento" },
          car_dealership: {
            businessInfo: {
              vehicleTypes: "Tipos de vehículos vendidos",
              newUsed: "Nuevos, usados o ambos",
              serviceArea: "Ciudades/región atendida",
              financing: "Financiamiento disponible",
              tradeIn: "Acepta vehículo en permuta",
              documentation: "Documentación necesaria",
              reservationPolicy: "Política de reserva",
              businessHours: "Horario de atención",
              address: "Dirección de la tienda",
              paymentMethods: "Formas de pago",
              evaluationContact: "Contacto para evaluación de vehículo",
            },
            qualification: {
              vehicleCategory: "Qué vehículo o categoría busca",
              priceRange: "Rango de precio",
              financingInterest: "Interés en financiamiento",
              downPayment: "Tiene entrada",
              tradeInVehicle: "Tiene vehículo en permuta",
              city: "Ciudad",
              purchaseTimeline: "Plazo de compra",
              visitPreference: "Prefiere atención presencial o remota",
            },
            faq: {
              financing: "¿Trabajan con financiamiento?",
              tradeIn: "¿Aceptan vehículo en permuta?",
              location: "¿Dónde queda la tienda?",
              documents: "¿Qué documentos son necesarios?",
              visit: "¿Puedo agendar una visita?",
            },
          },
          internet_provider: {
            businessInfo: {
              coverageArea: "Ciudades y barrios cubiertos",
              plans: "Planes ofrecidos",
              speeds: "Velocidades disponibles",
              residentialBusiness: "Atención residencial/empresarial",
              installation: "Instalación",
              equipment: "Equipos",
              contractTerms: "Fidelidad/contrato",
              support: "Soporte técnico",
              paymentMethods: "Formas de pago",
              businessHours: "Horario de atención",
              installationLeadTime: "Plazo medio de instalación",
            },
            qualification: {
              cityNeighborhood: "Ciudad y barrio",
              residentialBusiness: "Residencial o empresarial",
              desiredSpeed: "Velocidad deseada",
              deviceCount: "Cantidad de dispositivos",
              currentProvider: "Ya tiene internet",
              fixedIpNeed: "Necesidad de IP fija",
              coverageAddress: "Dirección para consulta de cobertura",
              issueOrSales: "Problema técnico o contratación",
            },
            faq: {
              coverage: "¿Atienden mi barrio?",
              plans: "¿Qué planes ofrecen?",
              installation: "¿Cómo funciona la instalación?",
              support: "¿Cómo funciona el soporte?",
              billing: "¿Cómo funciona la facturación?",
            },
          },
          security_company: {
            businessInfo: {
              ...
              serviceArea: "Región atendida",
              technicalVisits: "Visitas técnicas",
              contracts: "Contratos",
            },
            qualification: {
              propertyType: "Residencia o empresa",
              cityNeighborhood: "Ciudad/barrio",
              buildingType: "Tipo de inmueble",
              desiredService: "Servicio deseado",
              existingEquipment: "Ya tiene equipos",
              cameraSensorCount: "Cantidad de cámaras/sensores",
              urgency: "Urgencia",
              visitSchedule: "Mejor horario para visita",
            },
            faq: {
              services: "¿Qué servicios ofrecen?",
              visit: "¿Cómo agendar una visita técnica?",
              monitoring: "¿Cómo funciona el monitoreo?",
              contracts: "¿Cómo funcionan los contratos?",
              area: "¿Atienden mi región?",
            },
          },
          construction_materials: {
            ...
            qualification: {
              materialQuantity: "Material y cantidad",
              cityNeighborhood: "Ciudad/barrio",
              deliveryOrPickup: "Entrega o retiro",
              desiredDate: "Fecha deseada",
              consumerOrBusiness: "Consumidor final o empresa",
              fullQuoteNeed: "Necesidad de presupuesto completo",
            },
            faq: {
              delivery: "¿Hacen entregas?",
              pickup: "¿Puedo retirar en la tienda?",
              quote: "¿Cómo solicitar presupuesto?",
              payment: "¿Qué formas de pago aceptan?",
              catalog: "¿Tienen catálogo?",
            },
          },
          technical_assistance: {
            businessInfo: {
              equipmentTypes: "Equipos atendidos",
              brands: "Marcas",
              warranty: "Garantía",
              technicalVisit: "Visita técnica",
              quoting: "Presupuesto",
              estimatedLeadTimes: "Plazos estimados",
              address: "Dirección",
            ...
            qualification: {
              ...
              reportedIssue: "Defecto presentado",
              issueStart: "Cuándo comenzó",
              previousRepair: "Hubo intento de reparo",
              warrantyStatus: "Garantía",
              cityNeighborhood: "Ciudad/barrio",
              preferredSchedule: "Preferencia de horario",
            },
            faq: {
              warranty: "¿Cómo funciona la garantía?",
              visit: "¿Cómo agendar visita técnica?",
              brands: "¿Qué marcas atienden?",
              quote: "¿Cómo funciona el presupuesto?",
              hours: "¿Cuál es el horario de atención?",
            },
          },
          clinic: {
            businessInfo: {
              ...
              units: "Unidades",
              insurance: "Obras sociales/seguros",
              privateCare: "Atención particular",
              businessHours: "Horarios",
              address: "Dirección",
              schedulingPolicy: "Política de turnos",
            },
            qualification: {
              specialtyProcedure: "Especialidad/procedimiento",
              firstVisitOrReturn: "Primera consulta o retorno",
              preferredSchedule: "Preferencia de fecha/horario",
              unit: "Unidad",
              insuranceOrPrivate: "Obra social o particular",
              urgencyNote: "Urgencia (sin diagnosticar)",
            },
            faq: {
              scheduling: "¿Cómo agendar consulta?",
              insurance: "¿Qué obras sociales aceptan?",
              location: "¿Dónde queda la clínica?",
              specialties: "¿Qué especialidades atienden?",
              hours: "¿Cuál es el horario de atención?",
            },
          },
          dental_clinic: {
            businessInfo: {
              ...
              address: "Dirección",
              schedulingPolicy: "Política de turnos",
              emergencyGuidance: "Orientación para urgencias",
            },
            qualification: {
              procedure: "Procedimiento deseado",
              firstVisitOrReturn: "Primera consulta o retorno",
              preferredSchedule: "Preferencia de horario",
              unit: "Unidad",
              insuranceOrPrivate: "Obra social o particular",
              painOrUrgency: "Dolor o urgencia (sin diagnosticar)",
            },
            faq: {
              scheduling: "¿Cómo agendar?",
              insurance: "¿Aceptan obra social?",
              location: "¿Dónde queda la clínica?",
              procedures: "¿Qué procedimientos realizan?",
      ...
      knowledgeBase: {
        ...
        subtitle:
          "Organice documentos de la empresa en bases independientes. Extracción de texto disponible — sin RAG, embeddings ni consulta por IA en esta fase.",
        search: "Buscar bases…",
        emptyTitle: "Ninguna base registrada",
        emptyDescription: "Cree una base (ej.: Comercial, Soporte) para organizar documentos.",
        emptyDocumentsTitle: "Ningún documento",
        emptyDocumentsDescription:
          "Añada un documento manual, un sitio web o suba TXT/MD/PDF/DOCX.",
        uploadHint:
          "TXT, MD, PDF o DOCX — máx. 20 MB en upload; el procesamiento extrae hasta 5 MB. Sin OCR.",
        dashboard: {
          basesTotal: "Bases",
          documentsTotal: "Documentos",
          uploadsTotal: "Uploads",
          websitesTotal: "Sitios web",
          basesActive: "Activas",
          basesInactive: "Inactivas",
          documentsProcessed: "Procesados",
          documentsPending: "Pendientes",
          documentsProcessing: "Procesando",
          documentsError: "Con error",
          lastProcessingAt: "Último procesamiento",
          indexPending: "Índice pendiente",
          indexQueued: "Índice en cola",
          indexIndexing: "Indexando",
          indexCompleted: "Indexados",
          indexFailed: "Índice con error",
          indexOutdated: "Desactualizados",
          chunksTotal: "Chunks",
          lastIndexingAt: "Última indexación",
        ...
        fields: {
          ...
          enabled: "Activa",
          status: "Estado",
          processingStatus: "Procesamiento",
          indexStatus: "Indexación",
          chunkCount: "Chunks",
          ...
          durationMs: "Tiempo (ms)",
          lastError: "Último error",
          lastProcessedAt: "Procesado en",
          lastIndexedAt: "Indexado en",
        ...
        settings: {
          ...
          minChunkSize: "Tamaño mínimo",
          batchSize: "Batch de embeddings",
          enabled: "Indexación activa",
          outdatedWarning:
            "{{count}} documento(s) desactualizado(s) tras el cambio de configuración.",
        },
        searchTest: {
          title: "Probar búsqueda semántica",
          disclaimer:
            "Esta prueba valida la recuperación de conocimiento. El Agente de IA aún no usa estos resultados durante las atenciones.",
          query: "Pregunta",
          base: "Base",
        ...
        confirmBatchIndex:
          "¿Encolar indexación de {{count}} documento(s)? Esta acción consume créditos del proveedor de embeddings.",
        buttons: {
          newBase: "Nueva base",
          ...
          reindex: "Reindexar",
          search: "Buscar",
          searchTest: "Probar búsqueda",
          embeddingSettings: "Embeddings",
          indexPending: "Indexar pendientes",
          reindexOutdated: "Reindexar desactualizados",
          testCredential: "Probar credencial",
          openDocument: "Abrir documento",
        },
        modal: {
          newBase: "Nueva base de conocimiento",
        ...
        preview: {
          ...
          noExtractedText: "Aún sin texto extraído.",
        },
        confirmDeleteBaseTitle: "¿Eliminar base?",
        confirmDeleteBaseMessage:
          "Solo se pueden eliminar bases sin documentos. Esta acción no se puede deshacer.",
        confirmDeleteDocumentTitle: "¿Eliminar documento?",
        confirmDeleteDocumentMessage: "El documento se eliminará de esta base.",
        toasts: {
          nameRequired: "El nombre es obligatorio.",
          titleRequired: "El título es obligatorio.",
          urlRequired: "La URL es obligatoria.",
          fileRequired: "Seleccione un archivo.",
          queryRequired: "Indique la pregunta.",
          baseRequired: "Seleccione una base.",
          baseCreated: "Base creada.",
          baseUpdated: "Base actualizada.",
          ...
          reprocessQueued: "Reprocesamiento en cola.",
          processQueued: "Procesamiento en cola.",
          indexQueued: "Indexación en cola.",
          reindexQueued: "Reindexación en cola.",
          settingsSaved: "Configuración de embeddings guardada.",
          outdatedMarked: "{{count}} documento(s) marcado(s) como desactualizado(s).",
          batchQueued: "{{count}} documento(s) encolado(s) para indexación.",
          nothingToIndex: "No hay documentos pendientes para indexar.",
        },
      },
      contactModal: {
        title: {
        ...
        form: {
          ...
          assigneesHint:
            "Defina quién puede ver y gestionar este contacto.",
          numberPlaceholder: "Ej: 5527999999999",
          numberHelper:
            "Use código de país + DDD + número. Ej: 5527999999999",
          numberCountryHint:
            "Parece faltar el código de país ({{code}}). Ejemplo: {{code}}27999999999",
        },
        formErrors: {
          name: {
            required: "El nombre es obligatorio",
      ...
      mainDrawer: {
        ...
        attendanceUnreadBadge: "{{count}} conversaciones con mensajes no leídos",
        sections: {
          dashboard: "Dashboard",
          atendimento: "Atención",
          chatInterno: "Chat interno",
          equipe: "Equipo",
          automacao: "Automatizaciones",
          aiAgent: "Agente de IA",
          technicalConsole: "Consola Técnica",
          campanhas: "Campañas",
        ...
        listItems: {
          ...
          automationProduction: "Producción / RC",
      ...
      platform: {
        ...
        systemTools: {
          title: "Monitoreo y actualizaciones",
          subtitle:
            "Métricas del servidor y acciones Git seguras (lista blanca). Sin terminal libre.",
          ...
          refresh: {
            ...
            updatedAgo: "Actualizado hace {{seconds}}s",
            updatedJustNow: "Actualizado ahora",
            pausedHint: "Auto-actualización pausada",
            jobThrottleHint: "Intervalo mínimo de 10s durante acciones en ejecución",
          },
          monitorSection: "Monitoreo del servidor",
          updatesSection: "Actualizaciones del sistema",
          cpu: "CPU",
          cpuCores: "{{count}} núcleos",
          ram: "Memoria RAM",
          disk: "Disco",
          uptime: "Uptime del servidor",
          load: "Load average",
          backend: "Backend",
          gitStatus: "Estado Git (resumen)",
          projectSize: "Tamaño del proyecto",
          jobRunning: "Ya hay una acción en ejecución. Espere a que termine.",
          actions: {
            gitStatus: "Ver estado Git",
            gitLog: "Ver último commit",
            gitPull: "Ejecutar Git pull",
          },
          terminal: {
            title: "Terminal (solo lectura)",
            empty: "Ejecute una acción arriba para ver los logs aquí.",
            copy: "Copiar logs",
            clear: "Limpiar",
            ...
            requesting: "Solicitando ejecución: {{action}}…",
            accepted: "Acción aceptada ({{jobId}})",
            socketTimeout: "Sin logs en tiempo real — sincronizando desde el servidor…",
          },
          deploy: {
            section: "Build y deploy asistido",
            hint:
              "Acciones predefinidas en el servidor. Sin terminal libre ni parámetros personalizables.",
            recommendedOrder: "Orden manual sugerida",
            backendRestarting:
              "Backend reiniciando — espere unos segundos y actualice la página si es necesario.",
            steps: {
              gitPull: "Git pull",
              backendNpm: "npm install backend (si cambió package.json)",
              backendBuild: "Build backend",
              migrate: "Migration (si la actualización lo exige)",
              restart: "Restart backend",
              frontendNpm: "npm install frontend (si cambió package.json)",
              frontendBuild: "Build frontend",
            },
            actions: {
              backendNpmInstall: "Instalar dependencias backend",
              backendBuild: "Build backend",
              backendMigrate: "Ejecutar migrations",
              backendRestart: "Reiniciar backend",
              frontendNpmInstall: "Instalar dependencias frontend",
              frontendBuild: "Build frontend",
            },
            confirm: {
              backendNpmInstall: {
                title: "¿Instalar dependencias del backend?",
                body: "Ejecutará `npm install` en la carpeta backend. Puede tardar varios minutos.",
              },
              backendBuild: {
                title: "¿Build del backend?",
                body:
                  "Ejecutará `npm run build` en backend. Puede tardar varios minutos. El sistema sigue en línea hasta el restart.",
              },
              backendMigrate: {
                title: "¿Ejecutar migrations?",
                body:
                  "Ejecutará `npm run db:migrate`. Ejecute solo tras backup o cuando la actualización exija cambios en la base.",
              },
              backendRestart: {
                title: "¿Reiniciar backend?",
                body:
                  "Ejecutará `sudo systemctl restart` en el servicio configurado. El sistema puede quedar indisponible unos segundos y la conexión en tiempo real puede caer.",
              },
              frontendNpmInstall: {
                title: "¿Instalar dependencias del frontend?",
                body: "Ejecutará `npm install` en la carpeta frontend. Puede tardar varios minutos.",
              },
              frontendBuild: {
                title: "¿Build del frontend?",
                body:
                  "Ejecutará `npm run build` en frontend. Los archivos estáticos quedarán disponibles al terminar. No hace falta reiniciar frontend.",
              },
            },
          },
          fullUpdate: {
      ...
      globalNotifications: {
        ...
        backgroundSummaryOne: "Recibió 1 mensaje nuevo mientras estaba ausente.",
        backgroundSummary:
          "Recibió {{count}} mensajes nuevos mientras estaba ausente.",
      },
      ...
      backendErrors: {
        ...
        ERR_CONTACT_REQUIRES_ASSIGNEE:
          "Seleccione al menos un responsable del contacto.",
        ...
        ERR_MAX_PINNED_TICKETS:
          "Puede fijar como máximo 3 conversaciones. Desfije una para fijar otra.",
        ERR_PIN_ONLY_OPEN_TICKETS:
          "Solo puede fijar conversaciones en atención (pestaña Atendiendo).",
        ERR_NO_TICKET_FOUND: "No se encontró ningún ticket con este ID.",
        ERR_NO_USER_FOUND: "No se encontró ningún usuario con este ID.",
        ERR_NO_WAPP_FOUND: "No se encontró ningún WhatsApp con este ID.",
        ERR_NO_INSTAGRAM_ACCOUNT_FOUND: "Cuenta de Instagram no encontrada.",
        ERR_INSTAGRAM_ACCOUNT_DUPLICATE:
          "Esta cuenta de Instagram ya está conectada en esta empresa.",
        ERR_INSTAGRAM_TOKEN_INVALID:
          "Token inválido o expirado. Genere un nuevo token en Meta for Developers.",
        ERR_INSTAGRAM_TOKEN_MISSING_SCOPES:
          "El token no tiene todos los permisos necesarios para Instagram Direct.",
        ERR_INSTAGRAM_PROFILE_NOT_FOUND:
          "No se pudieron obtener los datos de la cuenta Instagram en Meta.",
        ERR_META_API_FAILED: "Error al consultar la API de Meta. Intente de nuevo.",
        ERR_META_API_TEMPORARY_FAILED:
          "Fallo temporal de la API de Meta. Espere un momento e intente de nuevo.",
        ...
        ERR_INSTAGRAM_WEBHOOK_SUBSCRIBE_FAILED:
          "Error al suscribir el webhook de la cuenta Instagram en Meta.",
        ERR_INSTAGRAM_TOKEN_NOT_CONFIGURED:
          "Cuenta sin token configurado.",
        ERR_INSTAGRAM_BUSINESS_ID_MISSING:
          "Instagram Business ID ausente en la cuenta.",
