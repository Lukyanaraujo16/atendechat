    ...
    translations: {
      ...
      technicalConsole: {
        accessDenied: {
          ...
          description:
            "Esta área está disponível somente para usuários internos autorizados.",
        },
        landing: {
      ...
      inventorySales: {
        ...
        subtitle: "Gerencie produtos, categorias, estoque e configurações do módulo.",
        tabs: {
          summary: "Resumo",
          products: "Produtos",
        ...
        permissions: {
          noTabAccessTitle: "Sem permissão para aceder ao módulo",
          noTabAccessDescription:
            "Peça ao administrador para liberar a visualização de Estoque e Vendas.",
        },
        summary: {
          ...
          actions: {
            ...
            newMovement: "Entrada / ajuste",
            viewStock: "Ver movimentações",
          },
        },
        products: {
          title: "Produtos",
          ...
          search: "Pesquisar nome, SKU ou código de barras",
          filterCategory: "Categoria",
          filterActive: "Estado",
          min: "mín.",
          noStockTracking: "Sem controlo",
          lowStockBadge: "Estoque baixo",
          viewHistory: "Histórico de estoque",
          ...
          validation: {
            ...
            salePrice: "Preço de venda inválido.",
            initialQty: "Quantidade inicial inválida.",
          },
          toasts: {
        ...
        categories: {
          ...
          emptyDescription: "Organize seus produtos em categorias.",
          deactivateTitle: "Desativar categoria",
          deactivateMessage: "Deseja desativar «{{name}}»?",
          columns: {
            name: "Nome",
        ...
        stock: {
          ...
          emptyDescription: "Registre entradas, saídas ou ajustes de estoque.",
          types: {
            in: "Entrada",
            out: "Saída",
            adjustment: "Ajuste",
          ...
          fields: {
            ...
            type: "Tipo",
            quantity: "Quantidade",
            targetBalance: "Saldo final",
            unitCost: "Custo unitário",
            notes: "Observação",
          },
          hints: {
            adjustment: "No ajuste, informe o saldo final desejado.",
            notesRequired: "Obrigatório para saída e ajuste.",
          },
          validation: {
            product: "Selecione um produto.",
            quantity: "Quantidade inválida.",
            quantityPositive: "Quantidade deve ser maior que zero.",
            notes: "Informe a observação.",
          },
          columns: {
            date: "Data",
            product: "Produto",
        ...
        sales: {
          title: "Vendas",
          new: "Nova venda",
          search: "Buscar número, cliente ou observação",
          filterStatus: "Status",
          filterPaymentStatus: "Pagamento",
          ...
          searchContact: "Pesquisar cliente…",
          cancelReasonLabel: "Motivo do cancelamento",
          confirmCompleteTitle: "Concluir venda",
          confirmCompleteMessage:
            "A venda será finalizada e o estoque será baixado. Deseja continuar?",
          confirmCancelTitle: "Cancelar venda",
          confirmCancelDraftMessage: "O rascunho será cancelado.",
          confirmCancelCompletedMessage:
            "A venda concluída será cancelada e o estoque será estornado.",
          confirmDeleteTitle: "Excluir rascunho",
          confirmDeleteMessage:
            "Esta ação remove o rascunho e todos os itens. Não pode ser desfeita.",
          emptyTitle: "Nenhuma venda encontrada",
          emptyDescription: "Crie uma nova venda para começar.",
          pagination: "Página {{page}} · {{count}} registo(s)",
          status: {
            draft: "Rascunho",
            completed: "Concluída",
            cancelled: "Cancelada",
          ...
          receipt: {
            ...
            paymentStatus: "Status financeiro",
            customer: "Cliente",
            seller: "Vendedor",
          ...
          fields: {
            ...
            paymentMethod: "Forma de pagamento",
            paymentStatus: "Status financeiro",
            paymentNotes: "Observação de pagamento",
            paidAmount: "Valor pago",
            paidAt: "Data do pagamento",
          },
          validation: {
            sellerRequired: "Selecione o vendedor antes de concluir.",
            cancelReason: "Informe o motivo do cancelamento.",
            paidAmount: "Valor pago inválido.",
            paidAmountMax: "Valor pago não pode ser maior que o total.",
          },
          totals: {
            subtotal: "Subtotal",
            discount: "Descontos",
          ...
          items: {
            ...
            validation: {
              product: "Selecione um produto.",
              quantity: "Quantidade inválida.",
              unitPrice: "Preço unitário inválido.",
            },
            toasts: {
        ...
        ticket: {
          sectionTitle: "Vendas deste atendimento",
          newSale: "Nova venda",
          openSale: "Venda",
          noSales: "Nenhuma venda vinculada a este atendimento.",
          existingSalesTitle: "Vendas do atendimento",
          existingSalesHint:
            "Este atendimento já possui vendas. Abra uma existente ou crie uma nova.",
          createNewAnyway: "Criar nova venda",
          ticketLabel: "Atendimento",
          toasts: {
            created: "Venda vinculada ao atendimento.",
          },
        },
        reports: {
          ...
          emptyDescription:
            "Não há vendas concluídas ou canceladas para os filtros selecionados.",
          noRows: "Nenhum registo neste relatório.",
          noSeller: "Sem vendedor",
          salesShort: "vendas",
          sellersTitle: "Vendas por vendedor",
          productsTitle: "Produtos mais vendidos",
          customersTitle: "Vendas por cliente",
          summary: {
            totalSold: "Total vendido",
            completedCount: "Vendas concluídas",
            averageTicket: "Ticket médio",
            totalCommission: "Comissão total",
            cancelledCount: "Vendas canceladas",
          ...
          export: {
            ...
            sellers: "Vendas por vendedor",
            products: "Produtos mais vendidos",
            customers: "Vendas por cliente",
            noData: "Não há dados para exportar com os filtros actuais.",
      ...
      dashboard: {
        ...
        mobile: {
          configurePeriod: "Configurar período personalizado",
          noData: "Nenhum dado disponível",
          userPerformance: "Performance de Usuários",
          queuePerformance: "Performance de Filas",
          connectionPerformance: "Performance de Conexões",
          chartsOverTime: "Atendimentos ao Longo do Tempo",
          chartsByUser: "Mensagens ao Longo do Tempo / Performance por Usuário",
          userColumn: "Usuário",
          queueColumn: "Fila",
          connectionColumn: "Conexão",
          statusColumn: "Status",
          total: "Total",
          avgTime: "Tempo Médio",
          rating: "Avaliação",
      ...
      kanban: {
        ...
        countFiltered: "{{filtered}} de {{total}}",
        searchEmptyColumn: "Nenhum ticket corresponde à busca nesta coluna.",
      ...
      connections: {
        ...
        instagram: {
          guide: {
            ...
            intro:
              "Conecte sua conta profissional do Instagram para receber e responder Directs pelo AtendeChat.",
            step1: "Clique em \"Adicionar conta Instagram\", informe o nome e salve.",
            step2: "Clique em \"Conectar com Instagram\" e autorize o app na Meta.",
            requirementsTitle: "Requisitos:",
            requirement1: "Conta Instagram profissional Business ou Creator",
            requirement2: "Permissões aprovadas na Meta",
            requirement3: "App autorizado na tela de login",
          },
          statusLabel: {
            CONNECTED: "Conectado",
          ...
          oauth: {
            ...
            refreshNow: "Renovar agora",
            refreshing: "Renovando…",
            refreshSuccess: "Conexão Instagram renovada com sucesso.",
            refreshDueChip: "Renovação próxima",
            errors: {
              state_invalid: "Não foi possível validar a conexão. Tente novamente.",
              state_expired: "A conexão expirou. Clique em conectar novamente.",
              missing_code: "A Meta não retornou autorização. Tente novamente.",
              missing_scopes: "A conta não concedeu todas as permissões necessárias.",
              not_business:
          ...
          table: {
            ...
            emptyHint: "Adicione uma conta e conecte com o Instagram.",
          ...
          webhook: {
            ...
            verifyTokenHint:
              "Configure o valor de META_WEBHOOK_VERIFY_TOKEN no servidor e use o mesmo token na Meta.",
            status: "Status",
      ...
      aiAgentProduct: {
        ...
        confirm: {
          activate_shadow: {
            ...
            body:
              "O modo de testes será ativado em {{count}} conexão(ões) vinculada(s) a este agente ({{names}}). O agente analisará os atendimentos sem responder automaticamente.",
            confirm: "Ativar modo de testes",
          },
          activate_live: {
            title: "Ativar atendimento automático",
            body:
              "O atendimento automático será ativado em {{count}} conexão(ões) ({{names}}). O agente poderá responder clientes automaticamente por todas elas. Confirme apenas se a configuração estiver revisada. Conexões desconectadas: {{disconnectedCount}}.",
            confirm: "Ativar atendimento automático",
          },
          deactivate: {
            title: "Desativar o Agente de IA",
            body:
              "As respostas automáticas serão interrompidas em {{count}} conexão(ões) ({{names}}). As configurações, credenciais e histórico serão preservados.",
            confirm: "Desativar",
          },
          unknown: {
            title: "Confirmar ação",
            body: "Esta ação não está disponível.",
            confirm: "OK",
          },
        },
        commandSuccess: {
          activate_shadow: "Modo de testes ativado.",
          activate_live: "Atendimento automático ativado.",
          deactivate: "Agente de IA desativado.",
          generic: "Ação concluída.",
        },
        commandErrors: {
          accessDenied: "Você não tem permissão para alterar o Agente de IA.",
          notAvailable: "O Agente de IA não está disponível no plano.",
          notReady: "Conclua a configuração antes de ativar o Agente de IA.",
        ...
        ambiguous: {
          description:
            "Encontramos {{count}} configurações de Agente de IA. Revise as configurações antes de ativar o atendimento.",
        },
        error: {
          title: "Não foi possível carregar o estado do Agente de IA",
          description:
            "Ocorreu um problema ao buscar as informações. Tente novamente em instantes.",
        },
        accessDenied: {
          title: "Acesso restrito",
          description:
            "Você não tem permissão para visualizar o Agente de IA nesta empresa.",
        },
        support: {
          activeCompany: "Empresa ativa: {{name}}",
        },
        status: {
          aria: "Status: {{status}}",
          unavailable: "Indisponível no plano",
          not_created: "Agente ainda não criado",
        ...
        statusDescription: {
          unavailable:
            "O Agente de IA não está incluído no plano atual desta empresa.",
          not_created:
            "Crie o Agente de IA para começar a configurar o atendimento automatizado.",
          setup_incomplete:
            "Ainda faltam algumas etapas para deixar o Agente pronto.",
          ready_to_activate:
            "A configuração está completa. Revise as conexões antes de ativar o atendimento.",
          active:
            "O Agente de IA está em operação no modo atual da conexão vinculada.",
          paused:
            "O Agente está pausado. A retomada estará disponível quando a ativação comercial estiver habilitada.",
          attention_required:
            "Há algo que precisa da sua atenção antes de seguir com o atendimento automatizado.",
        },
        mode: {
          aria: "Modo: {{mode}}",
          off: "Desativado",
          shadow: "Modo de testes",
          live: "Atendimento automático",
          paused: "Pausado",
        },
        checklist: {
          title: "Checklist de configuração",
          aria: "Itens de configuração do Agente de IA",
        },
        checkStatus: {
          complete: "Concluído",
          pending: "Pendente",
        ...
        nextAction: {
          upgrade_plan: "Ver plano",
          create_agent: "Criar Agente de IA",
          configure_agent: "Continuar configuração",
          configure_provider: "Configurar provedor",
          connect_whatsapp: "Conectar ao WhatsApp",
          fix_connection: "Revisar conexão",
          resolve_conflict: "Revisar configuração",
          activate_shadow: "Ativar modo de testes",
          activate_live: "Ativar atendimento automático",
          resume_agent: "Retomar agente",
          none: "Nenhuma ação",
          reviewConfig: "Revisar configuração",
          mutationDeferred:
            "A retomada do agente estará disponível quando houver pausa operacional global no produto.",
        },
        secondary: {
        ...
        meta: {
          ...
          readyTrue: "Pronto conforme o estado do produto.",
          readyFalse: "Ainda não está pronto para operação plena.",
          connectionScope:
            "{{count}} conexão(ões) vinculada(s) ({{connected}} conectada(s), {{disconnected}} desconectada(s))",
        },
      },
      aiAgent: {
        title: "Agente de IA",
        subtitle:
          "Configure atendentes virtuais com inteligência artificial para auxiliar no atendimento.",
        phaseWarning:
        ...
        shadowSection: {
          ...
          evaluationHint:
            "Use as avaliações para comparar provedores e ajustar o prompt antes de ativar respostas automáticas.",
          ...
          summary: {
            ...
            generated: "Geradas",
            failed: "Falhas",
            goodReviews: "Avaliações boas",
            badReviews: "Avaliações ruins",
          },
          table: {
            date: "Data",
            agent: "Agente",
          ...
          actions: {
            ...
            review: "Avaliar sugestão",
          },
          details: {
            title: "Detalhes da sugestão",
            reason: "Motivo da elegibilidade",
            credentialSource: "Origem da credencial",
            suggestionSource: "Fonte da sugestão",
            contextMessages: "Mensagens no contexto",
            evaluatorVersion: "Versão do avaliador",
          },
          review: {
            title: "Avaliar sugestão",
            ratingLabel: "Avaliação",
            tagsLabel: "Tags",
            noteLabel: "Observação (opcional)",
            toastSaved: "Avaliação salva",
            ratings: {
              good: "Boa",
              bad: "Ruim",
              neutral: "Neutra",
            ...
            tags: {
              useful: "Útil",
              inventedInformation: "Inventou informação",
              tooLong: "Muito longa",
              tooShort: "Muito curta",
              needsHuman: "Precisa humano",
              wrongTone: "Tom inadequado",
        ...
        buttons: {
          ...
          delete: "Excluir",
          retry: "Tentar novamente",
          simulateConversation: "Simular conversa",
          configureKnowledge: "Base de conhecimento",
        },
        knowledge: {
          title: "Base de conhecimento do agente",
          loading: "Carregando configurações…",
          hint:
            "Vincule bases indexadas e configure a recuperação (RAG) por canal. O Live exige validação prévia no simulador e shadow.",
          fields: {
            enabled: "Ativar Base de Conhecimento neste agente",
            enabledInSimulator: "Usar no simulador",
            enabledInShadow: "Usar no Shadow Mode",
            enabledInLive: "Usar no Live Mode",
            topK: "Top K (trechos)",
            minimumScore: "Score mínimo",
            maxContextCharacters: "Máx. caracteres no contexto",
            maxContextTokens: "Máx. tokens no contexto",
            maxChunksPerDocument: "Máx. trechos por documento",
            maxChunksPerBase: "Máx. trechos por base",
            allowAnswerWithoutKnowledge:
              "Permitir resposta sem conhecimento recuperado",
            handoffWhenKnowledgeMissing:
              "Sugerir handoff quando não houver conhecimento",
          },
          channels: {
            title: "Canais de uso",
          },
          alerts: {
            noLinkedBases:
              "Nenhuma base vinculada. Vincule ao menos uma base para recuperar conhecimento.",
            liveWithoutChannels:
              "Live ativo sem simulador e/ou shadow. Valide a recuperação nesses ambientes antes de produção.",
          },
          bases: {
            title: "Bases vinculadas",
            empty: "Nenhuma base de conhecimento cadastrada na empresa.",
            disabled: "base desativada",
            priority: "Prioridade",
            linkEnabled: "Ativa no agente",
          },
          retrieval: {
            title: "Parâmetros de recuperação",
          },
          test: {
            title: "Testar conhecimento deste Agente",
            subtitle:
              "Executa apenas a busca semântica — não gera resposta do modelo.",
            queryLabel: "Consulta de teste",
            run: "Executar teste",
            status: "Status",
          ...
          skipReasons: {
            ...
            no_linked_bases: "Sem bases vinculadas",
            no_active_bases: "Sem bases ativas",
            missing_embedding_settings: "Embeddings não configurados",
            invalid_credential: "Credencial inválida",
            empty_query: "Consulta vazia",
            feature_blocked: "Recurso bloqueado no plano",
            context_budget_unavailable: "Orçamento de contexto indisponível",
            document_not_indexed: "Documento não indexado",
          },
          liveConfirm: {
            title: "Ativar conhecimento no Live",
            message:
              "Recomendamos validar a recuperação no simulador e no Shadow Mode antes de habilitar no Live. Deseja continuar mesmo assim?",
          },
          buttons: {
            saveSettings: "Salvar parâmetros",
            saveLinks: "Salvar vínculos",
          },
          toasts: {
            settingsSaved: "Parâmetros de conhecimento salvos",
            linksSaved: "Bases vinculadas atualizadas",
          },
          shadow: {
            used: "Usou conhecimento · {{count}} fonte(s) · score {{score}}",
                  filterWith: "Com conhecimento",
                  filterWithout: "Sem conhecimento",
                  filterEmpty: "Recuperação vazia",
                  filterError: "Falha na recuperação",
                  knowledgeFilter: "Conhecimento",
            detailsTitle: "Conhecimento recuperado",
          },
        },
        simulator: {
          title: "Simulador do atendente",
          untitled: "Atendente virtual",
          badge: "Ambiente de simulação",
          warning:
            "Esta conversa é apenas uma simulação e não será enviada a nenhum cliente.",
          handoffBadge: "O atendente pediria ajuda humana aqui",
          knowledge: {
          ...
          buttons: {
            ...
            editAgent: "Editar atendente",
            copy: "Copiar resposta",
            review: "Avaliar resposta",
          ...
          empty: {
            title: "Comece uma conversa de teste",
            hint: "Envie uma mensagem ou escolha um cenário sugerido abaixo.",
          },
          scenarios: {
            title: "Cenários sugeridos",
            default: {
              greeting: "Olá, gostaria de saber mais sobre os serviços.",
              humanRequest: "Quero falar com um atendente.",
              pricingQuestion: "Qual o preço?",
              serviceArea: "Vocês atendem na minha região?",
              quoteRequest: "Quero fazer um orçamento.",
            },
          },
          summary: {
            title: "Resumo da sessão",
            messages: "Mensagens: {{count}}/{{max}}",
            tokens: "Tokens: {{count}}",
            latency: "Latência média: {{ms}}ms",
          },
          review: {
            ...
            tags: {
              invented_information: "Inventou informação",
              too_long: "Muito longa",
              too_short: "Muito curta",
              wrong_tone: "Tom inadequado",
              should_call_human: "Deveria chamar humano",
              unnecessary_handoff: "Chamou humano sem necessidade",
              useful: "Útil",
              other: "Outro",
            },
          },
          errors: {
            ...
            sessionLimit: "Limite de mensagens da sessão atingido. Reinicie a conversa.",
            messageTooLong: "Mensagem muito longa.",
            sessionEnded: "Esta sessão já foi encerrada.",
            provider: "Não foi possível gerar resposta ({{code}}).",
            generic: "Não foi possível completar a simulação.",
            custom: "Erro na simulação.",
          },
          toasts: {
            restarted: "Nova conversa iniciada",
        ...
        wizard: {
          ...
          buttons: {
            ...
            testAttendant: "Testar atendente",
          ...
          hints: {
            ...
            suggestedFaqsReview:
              "Revise e responda as perguntas sugeridas antes de concluir.",
          },
          segment: {
            panelTitle: "Recomendações para {{segment}}",
            panelHint:
              "Sugerimos opções seguras para este tipo de negócio. Nada será aplicado sem sua confirmação.",
            applyButton: "Aplicar recomendações",
            applyConfirmTitle: "Aplicar recomendações do segmento?",
            applyConfirmMessage:
              "Serão adicionados até {{departments}} departamento(s), {{actions}} ação(ões) e {{handoffs}} regra(s) de handoff. Campos já preenchidos não serão alterados.",
            ...
            chipQuestions: "{{count}} perguntas",
            qualificationTitle: "Perguntas úteis de qualificação",
            checklistTitle: "Para melhorar o atendimento, informe quando possível:",
            checklistDone: "informado",
        ...
        segmentTemplates: {
          other: { title: "Outro segmento" },
          car_dealership: {
            businessInfo: {
              vehicleTypes: "Tipos de veículos vendidos",
              newUsed: "Novos, seminovos ou ambos",
              serviceArea: "Cidades/região atendida",
              financing: "Financiamento disponível",
              tradeIn: "Aceita veículo na troca",
              documentation: "Documentação necessária",
              reservationPolicy: "Política de reserva",
              businessHours: "Horário de funcionamento",
              address: "Endereço da loja",
              paymentMethods: "Formas de pagamento",
              evaluationContact: "Contato para avaliação de veículo",
            },
            qualification: {
              vehicleCategory: "Qual veículo ou categoria procura",
              priceRange: "Faixa de preço",
              financingInterest: "Interesse em financiar",
              downPayment: "Possui entrada",
              tradeInVehicle: "Possui veículo na troca",
              city: "Cidade",
              purchaseTimeline: "Prazo de compra",
              visitPreference: "Prefere atendimento presencial ou remoto",
            },
            faq: {
              financing: "Vocês trabalham com financiamento?",
              tradeIn: "Aceitam veículo na troca?",
              location: "Onde fica a loja?",
              documents: "Quais documentos são necessários?",
              visit: "Posso agendar uma visita?",
            },
            simulation: {
              priceBudget: "Estou procurando um carro até R$ 80 mil.",
              tradeIn: "Vocês aceitam meu veículo na troca?",
              financingApproval: "Consegue aprovar financiamento?",
              talkToSeller: "Quero falar com um vendedor.",
            },
          },
          internet_provider: {
            businessInfo: {
              coverageArea: "Cidades e bairros cobertos",
              plans: "Planos oferecidos",
              speeds: "Velocidades disponíveis",
              residentialBusiness: "Atendimento residencial/empresarial",
              installation: "Instalação",
              equipment: "Equipamentos",
              contractTerms: "Fidelidade/contrato",
              support: "Suporte técnico",
              paymentMethods: "Formas de pagamento",
              businessHours: "Horário de atendimento",
              installationLeadTime: "Prazo médio de instalação",
            },
            qualification: {
              cityNeighborhood: "Cidade e bairro",
              residentialBusiness: "Residencial ou empresarial",
              desiredSpeed: "Velocidade desejada",
              deviceCount: "Quantidade de dispositivos",
              currentProvider: "Já possui internet",
              fixedIpNeed: "Necessidade de IP fixo",
              coverageAddress: "Endereço para consulta de cobertura",
              issueOrSales: "Problema técnico ou contratação",
            },
            faq: {
              coverage: "Atendem meu bairro?",
              plans: "Quais planos vocês oferecem?",
              installation: "Como funciona a instalação?",
              support: "Como funciona o suporte?",
          ...
          security_company: {
            businessInfo: {
              ...
              residentialBusiness: "Residencial/empresarial",
              serviceArea: "Região atendida",
              technicalVisits: "Visitas técnicas",
              contracts: "Contratos",
            },
            qualification: {
              propertyType: "Residência ou empresa",
              cityNeighborhood: "Cidade/bairro",
              buildingType: "Tipo de imóvel",
              desiredService: "Serviço desejado",
              existingEquipment: "Já possui equipamentos",
              cameraSensorCount: "Quantidade de câmeras/sensores",
              urgency: "Urgência",
              visitSchedule: "Melhor horário para visita",
            },
            faq: {
              services: "Quais serviços vocês oferecem?",
              visit: "Como agendar uma visita técnica?",
              monitoring: "Como funciona o monitoramento?",
              contracts: "Como funcionam os contratos?",
              area: "Atendem minha região?",
            },
          },
          construction_materials: {
            businessInfo: {
              materialCategories: "Categorias de materiais",
              delivery: "Entrega",
              serviceArea: "Área atendida",
            ...
            qualification: {
              materialQuantity: "Material e quantidade",
              cityNeighborhood: "Cidade/bairro",
              deliveryOrPickup: "Entrega ou retirada",
              desiredDate: "Data desejada",
              consumerOrBusiness: "Consumidor final ou empresa",
              fullQuoteNeed: "Necessidade de orçamento completo",
            },
            faq: {
              delivery: "Fazem entrega?",
              pickup: "Posso retirar na loja?",
              quote: "Como solicitar orçamento?",
              payment: "Quais formas de pagamento?",
              catalog: "Vocês têm catálogo?",
            },
          },
          technical_assistance: {
            businessInfo: {
              equipmentTypes: "Equipamentos atendidos",
              brands: "Marcas",
              warranty: "Garantia",
              technicalVisit: "Visita técnica",
              quoting: "Orçamento",
              estimatedLeadTimes: "Prazos estimados",
              address: "Endereço",
            ...
            qualification: {
              ...
              reportedIssue: "Defeito apresentado",
              issueStart: "Quando começou",
              previousRepair: "Já houve tentativa de reparo",
              warrantyStatus: "Garantia",
              cityNeighborhood: "Cidade/bairro",
              preferredSchedule: "Preferência de horário",
            },
            faq: {
              warranty: "Como funciona a garantia?",
              visit: "Como agendar visita técnica?",
              brands: "Quais marcas atendem?",
              quote: "Como funciona o orçamento?",
              hours: "Qual o horário de atendimento?",
            },
          },
          clinic: {
            businessInfo: {
            ...
            qualification: {
              specialtyProcedure: "Especialidade/procedimento",
              firstVisitOrReturn: "Primeira consulta ou retorno",
              preferredSchedule: "Preferência de data/horário",
              unit: "Unidade",
              insuranceOrPrivate: "Convênio ou particular",
              urgencyNote: "Urgência (sem diagnóstico)",
            },
            faq: {
              scheduling: "Como agendar consulta?",
              insurance: "Quais convênios aceitam?",
              location: "Onde fica a clínica?",
              specialties: "Quais especialidades atendem?",
              hours: "Qual o horário de funcionamento?",
            },
          },
          dental_clinic: {
            businessInfo: {
              ...
              units: "Unidades",
              insurance: "Convênios",
              privateCare: "Particular",
              businessHours: "Horários",
              address: "Endereço",
              schedulingPolicy: "Política de agendamento",
              emergencyGuidance: "Orientação para urgências",
            },
            qualification: {
              ...
              unit: "Unidade",
              insuranceOrPrivate: "Convênio ou particular",
              painOrUrgency: "Dor ou urgência (sem diagnóstico)",
            },
            faq: {
              scheduling: "Como agendar?",
              insurance: "Aceitam convênio?",
              location: "Onde fica a clínica?",
              procedures: "Quais procedimentos realizam?",
        ...
        formErrors: {
          name: {
            required: "Nome do agente é obrigatório",
            long: "Nome muito longo (máx. 120 caracteres)",
          },
          model: { required: "Modelo é obrigatório" },
          temperature: {
            required: "Temperatura é obrigatória",
            range: "Temperatura deve estar entre 0 e 2",
          },
          maxTokens: {
            required: "Máximo de tokens é obrigatório",
            integer: "Máximo de tokens deve ser um número inteiro",
            range: "Máximo de tokens deve estar entre 16 e 4096",
          },
        },
        toasts: {
      ...
      knowledgeBase: {
        ...
        subtitle:
          "Organize documentos da empresa em bases independentes. Extração de texto disponível — sem RAG, embeddings ou consulta pela IA nesta fase.",
        search: "Pesquisar bases…",
        emptyTitle: "Nenhuma base cadastrada",
        emptyDescription: "Crie uma base (ex.: Comercial, Suporte) para começar a organizar documentos.",
        emptyDocumentsTitle: "Nenhum documento",
        emptyDocumentsDescription:
          "Adicione um documento manual, um website ou faça upload de TXT/MD/PDF/DOCX.",
        uploadHint:
          "TXT, MD, PDF ou DOCX — máx. 20 MB no upload; processamento extrai até 5 MB. Sem OCR.",
        dashboard: {
          basesTotal: "Bases",
          ...
          basesActive: "Ativas",
          basesInactive: "Inativas",
          documentsProcessed: "Processados",
          documentsPending: "Pendentes",
          documentsProcessing: "Processando",
          documentsError: "Com erro",
          lastProcessingAt: "Último processamento",
          indexPending: "Índice pendente",
          indexQueued: "Índice na fila",
          indexIndexing: "Indexando",
          indexCompleted: "Indexados",
          indexFailed: "Índice com erro",
          indexOutdated: "Desatualizados",
          chunksTotal: "Chunks",
          lastIndexingAt: "Última indexação",
        ...
        fields: {
          ...
          enabled: "Ativa",
          status: "Status",
          processingStatus: "Processamento",
          indexStatus: "Indexação",
          chunkCount: "Chunks",
          ...
          lastProcessedAt: "Processado em",
          lastIndexedAt: "Indexado em",
        ...
        settings: {
          ...
          minChunkSize: "Tamanho mínimo",
          batchSize: "Batch de embeddings",
          enabled: "Indexação ativa",
          outdatedWarning:
            "{{count}} documento(s) desatualizado(s) após mudança de configuração.",
        },
        searchTest: {
          title: "Testar busca semântica",
          disclaimer:
            "Este teste valida a recuperação de conhecimento. O Agente de IA ainda não utiliza estes resultados durante os atendimentos.",
          query: "Pergunta",
          base: "Base",
        ...
        confirmBatchIndex:
          "Enfileirar indexação de {{count}} documento(s)? Esta ação consome créditos do provider de embeddings.",
        buttons: {
          newBase: "Nova base",
          newDocument: "Novo documento",
          newWebsite: "Novo website",
          upload: "Upload",
          ...
          reindex: "Reindexar",
          search: "Buscar",
          searchTest: "Testar busca",
          embeddingSettings: "Embeddings",
          indexPending: "Indexar pendentes",
          reindexOutdated: "Reindexar desatualizados",
          testCredential: "Testar credencial",
          openDocument: "Abrir documento",
        },
        modal: {
          newBase: "Nova base de conhecimento",
        ...
        preview: {
          ...
          noExtractedText: "Ainda sem texto extraído.",
        },
        confirmDeleteBaseTitle: "Excluir base?",
        confirmDeleteBaseMessage:
          "Só é possível excluir bases sem documentos. Esta ação não pode ser desfeita.",
        confirmDeleteDocumentTitle: "Excluir documento?",
        confirmDeleteDocumentMessage: "O documento será removido desta base.",
        toasts: {
          nameRequired: "Nome é obrigatório.",
          titleRequired: "Título é obrigatório.",
          urlRequired: "URL é obrigatória.",
          fileRequired: "Selecione um ficheiro.",
          queryRequired: "Informe a pergunta.",
          baseRequired: "Selecione uma base.",
          baseCreated: "Base criada.",
          baseUpdated: "Base atualizada.",
          baseDeleted: "Base excluída.",
          baseDuplicated: "Base duplicada.",
          ...
          reprocessQueued: "Reprocessamento enfileirado.",
          processQueued: "Processamento enfileirado.",
          indexQueued: "Indexação enfileirada.",
          reindexQueued: "Reindexação enfileirada.",
          settingsSaved: "Configuração de embeddings guardada.",
          outdatedMarked: "{{count}} documento(s) marcado(s) como desatualizado(s).",
          batchQueued: "{{count}} documento(s) enfileirado(s) para indexação.",
          nothingToIndex: "Não há documentos pendentes para indexar.",
        },
      },
      contactModal: {
        title: {
      ...
      ticket: {
        ...
        orphan: {
          ...
          inputHint:
            "Este atendimento está sem conexão ativa. Reatribua uma conexão para responder.",
          inputPlaceholder:
            "Reatribua uma conexão para enviar mensagens",
        },
      ...
      mainDrawer: {
        ...
        sections: {
          ...
          technicalConsole: "Console Técnico",
          campanhas: "Campanhas",
      ...
      platform: {
        ...
        systemTools: {
          title: "Monitoramento e atualizações",
          subtitle:
            "Métricas do servidor e ações Git seguras (whitelist). Sem terminal livre.",
          ...
          refresh: {
            ...
            updatedAgo: "Atualizado há {{seconds}}s",
            updatedJustNow: "Atualizado agora",
            pausedHint: "Auto-atualização pausada",
            jobThrottleHint: "Intervalo mínimo de 10s durante ações em execução",
          },
          monitorSection: "Monitoramento do servidor",
          updatesSection: "Atualizações do sistema",
          cpu: "CPU",
          ...
          load: "Load average",
          backend: "Backend",
          gitStatus: "Status Git (resumo)",
          projectSize: "Tamanho do projeto",
          jobRunning: "Já existe uma ação em execução. Aguarde a conclusão.",
          actions: {
            gitStatus: "Ver status Git",
            gitLog: "Ver último commit",
            gitPull: "Executar Git Pull",
          },
          terminal: {
            title: "Terminal (somente leitura)",
            empty: "Execute uma ação acima para ver os logs aqui.",
            copy: "Copiar logs",
            clear: "Limpar",
          ...
          fullUpdate: {
            ...
            description:
              "Executa em sequência: Git status, pull, dependências, build, migrations e restart do backend. Sem restart de frontend.",
            action: "Executar atualização completa",
            backupWarning:
              "Recomendamos backup recente antes de rodar migrations. Não há backup automático nesta ação.",
            confirm: {
              title: "Executar atualização completa?",
              body:
                "Essa ação irá buscar atualizações do Git, instalar dependências, compilar backend/frontend, rodar migrations e reiniciar o backend. O sistema pode ficar indisponível por alguns segundos.",
              ack: "Entendo que devo ter backup recente antes de rodar migrations.",
            },
            steps: {
      ...
      flowBuilderList: {
        ...
        fromTemplate: "Criar a partir de template",
        active: "Ativo",
        inactive: "Inativo",
        updatedAt: "Atualizado {{date}}",
        nodeCount: "{{count}} bloco(s)",
        noNodes: "Sem blocos ainda",
        mobile: {
          filters: "Filtros",
          flowActions: "Ações do fluxo",
          viewSummary: "Ver resumo",
          editName: "Editar nome",
          openAdvancedEditor: "Abrir editor visual",
          duplicate: "Duplicar",
          delete: "Excluir",
          editorWarningTitle: "Editor visual no celular",
          editorWarningBody:
            "A edição visual avançada funciona melhor no computador. No celular você pode consultar o resumo e ajustar o nome do fluxo.",
          openAnyway: "Abrir mesmo assim",
          viewSummaryAction: "Ver resumo",
          editorDesktopHint:
            "A edição visual avançada é recomendada no computador. Use esta tela para consultar blocos e ajustes básicos.",
          blocksTitle: "Blocos do fluxo",
          connectionsCount: "{{count}} conexão(ões)",
          backToList: "Voltar à lista",
      ...
      backendErrors: {
        ...
        ERR_KNOWLEDGE_UPLOAD_TOO_LARGE: "Ficheiro excede o tamanho máximo de 20 MB.",
        ERR_KNOWLEDGE_UPLOAD_EMPTY: "Ficheiro vazio.",
        ...
        ERR_KNOWLEDGE_PROCESSING_TIMEOUT: "Tempo limite de processamento excedido.",
        ERR_KNOWLEDGE_PROCESSING_PDF_IMAGE_ONLY:
          "Este PDF parece ser baseado em imagens. OCR não está disponível nesta fase.",
        ...
        ERR_META_WEBHOOK_VERIFY_FORBIDDEN:
          "Verificação do webhook recusada. Confira o Verify Token na Meta.",
