    ...
    translations: {
      ...
      whatsappModal: {
        ...
        form: {
          ...
          connectionProvider: "Tipo de conexão",
      ...
      qrCodeModal: {
        ...
        waitingStatus: "Aguardando sessão ({{status}})...",
      ...
      aiAgentProduct: {
        ...
        support: {
          activeCompany: "Empresa ativa: {{name}}",
          configuring:
            "Você está configurando esta empresa em modo suporte.",
          configuringCompany:
            "Você está configurando a empresa {{name}} em modo suporte.",
          mutationHint:
            "Esta alteração será aplicada à empresa em modo suporte.",
        },
        status: {
          aria: "Status: {{status}}",
        ...
        secondary: {
          ...
          openWizard: "Editar identidade",
          editIdentity: "Editar identidade",
          editIntelligence: "Editar inteligência",
        ...
        admin: {
          tabsAria: "Seções do Agente de IA",
          sections: {
          ...
          settingsHint: "Modo operacional e ações administrativas.",
          activeLockDescription:
            "Este agente está ativo. Você pode ver todas as configurações, mas alterações de provedor, modelo, credencial, instruções e conhecimento exigem desativar o agente primeiro. A identidade e as mensagens podem ser editadas a qualquer momento.",
          fields: {
            name: "Nome do agente",
            description: "Descrição",
            fallback: "Mensagem de fallback",
            handoff: "Mensagem de transferência",
            provider: "Provedor de IA",
            model: "Modelo de IA",
          ...
          faqEmpty: "Nenhuma pergunta frequente cadastrada.",
          addFaq: "Adicionar pergunta",
          removeFaq: "Remover",
          linkedBases: "Bases vinculadas a este agente",
          linkedBasesEmpty: "Nenhuma base vinculada ainda.",
          availableBases: "Biblioteca da empresa",
          availableBasesEmpty: "Não há bases cadastradas na empresa.",
          indexedDocs: "{{count}} documento(s) indexado(s)",
          enabled: "Ativa",
          disabled: "Inativa",
          save: "Salvar",
          saving: "Salvando…",
          ...
          openLibrary: "Abrir biblioteca de conhecimento",
          editFaq: "Editar perguntas frequentes",
          currentMode: "Modo atual: {{mode}}",
          toolsDeferred:
            "Ferramentas avançadas e recursos técnicos permanecem no Console Técnico.",
          errors: {
            activeLocked:
              "Desative o agente antes de alterar esta configuração.",
          },
      ...
      backendErrors: {
        ...
        ERR_EVOLUTION_TECHNICAL_FIELDS_NOT_ALLOWED:
          "Credenciais técnicas Evolution não podem ser enviadas pelo cliente.",
        ERR_EVOLUTION_CENTRAL_CONFIG_MISSING:
          "A infraestrutura Evolution ainda não está configurada no servidor.",
        ERR_EVOLUTION_CENTRAL_CONFIG_INVALID:
          "A configuração Evolution do servidor é inválida. Contate o suporte da plataforma.",
        ERR_WHATSAPP_CONNECTION_PROVIDER_INVALID:
          "Tipo de conexão inválido.",
        ERR_WHATSAPP_CONNECTION_PROVIDER_IMMUTABLE:
          "O tipo de conexão não pode ser alterado após a criação.",
        ERR_EVOLUTION_CREDENTIAL_MISSING:
          "Credenciais da sessão Evolution não encontradas. Contate o suporte.",
        ERR_EVOLUTION_API_ERROR:
          "Falha na comunicação com a infraestrutura Evolution. Tente novamente.",
        ERR_EVOLUTION_TIMEOUT:
          "Tempo esgotado ao comunicar com a infraestrutura Evolution.",
        ERR_EVOLUTION_LOGOUT_FAILED:
          "Não foi possível desconectar a sessão Evolution. Tente novamente.",
        ERR_EVOLUTION_INVALID_INSTANCE_NAME:
          "Identificador interno da sessão Evolution inválido.",
        ERR_STAGE_HAS_DEALS:
