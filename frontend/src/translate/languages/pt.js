  ...
  pt: {
    translations: {
      ...
      platform: {
        ...
        companies: {
          ...
          billingMessageTemplate:
            "Olá, {{name}}. Referente ao plano {{plan}}, o vencimento é {{date}}. Pedimos que regularize para manter o serviço ativo. Obrigado.",
      ...
      agenda: {
        ...
        emptyState: "Nenhum evento neste período.",
