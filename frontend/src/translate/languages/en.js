			...
			whatsappModal: {
				...
				form: {
					...
					connectionProviderHint:
						"Choose the WhatsApp connection type.",
				},
				buttons: {
					okAdd: "Add",
					okEdit: "Save",
			...
			aiAgentProduct: {
				...
				admin: {
					...
					media: {
						...
						reasonProvider: "provider transcription (STT)",
						recommendVisionModel:
							"To analyze photos, choose a vision-capable model (e.g. GPT-4o mini or Gemini Flash).",
					},
					knowledgeHint:
					...
					settingsHint: "Operating mode and administrative actions.",
					activeLockDescription:
						"This agent is active. You can view all settings, but changing provider, model, credential, instructions or knowledge requires deactivating the agent first. Identity and messages can be edited anytime.",
					fields: {
						name: "Agent name",
						description: "Description",
					...
					addFaq: "Add question",
					removeFaq: "Remove",
					linkedBases: "Bases linked to this agent",
					linkedBasesEmpty: "No bases linked yet.",
					availableBases: "Company library",
					availableBasesEmpty: "No bases registered for this company.",
					indexedDocs: "{{count}} indexed document(s)",
					enabled: "Enabled",
					disabled: "Disabled",
					save: "Save",
					saving: "Saving…",
					...
					openLibrary: "Open knowledge library",
					editFaq: "Edit FAQs",
					currentMode: "Current mode: {{mode}}",
					toolsDeferred:
						"Advanced tools and technical resources remain in the Technical Console.",
					errors: {
						activeLocked:
							"Deactivate the agent before changing this configuration.",
					},
