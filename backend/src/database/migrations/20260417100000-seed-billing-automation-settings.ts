...
const ROWS: [string, string][] = [
  ["billingAuto_daysBeforeDueWarning", "3"],
  ["billingAuto_daysAfterDueWarning", "1"],
  ["billingAuto_daysAfterDueBlock", "3"],
  ["billingAuto_enableAutoBlock", "true"],
  ["billingAuto_enableAutoWarning", "true"]
];
