...
export const pauseAiAgent = async (
  ...
  return res.status(200).json({
    ...
    aiAgentHandoffRequested: enriched.aiAgentHandoffRequested,
    aiAgentHandoffRequestedAt: ticket.aiAgentHandoffRequestedAt,
    aiAgentHandoffReason: enriched.aiAgentHandoffReason,
    aiAgentHandoffBy: ticket.aiAgentHandoffBy,
